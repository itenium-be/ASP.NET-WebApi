...
public class RolesController : VersionNeutralApiController
{
    ...
    public Task<List<RoleDto>> GetList(CancellationToken cancellationToken)
    {
    ...
    public Task<RoleDto> GetById(string id)
    {
    ...
    public Task<RoleDto> GetByIdWithPermissions(string id, CancellationToken cancellationToken)
    {
    ...
    public Task<string> RegisterRole(CreateOrUpdateRoleRequest request)
    {
